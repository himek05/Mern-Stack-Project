    ...
    <div className="container max-w-screen-2xl mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10">
      <div className="w-full order-2 md:order-1 md:w-1/2 mt-12 md:mt-36">
        <div className="space-y-8">
          ...
          <p className="text-sm md:text-xl text-yellow-500">
          ...
          <label className="input input-bordered flex items-center gap-2 text-red-600">
            <svg
            ...
            <input
              type="text"
              className="grow text-red-600 border-yellow-400"
              placeholder="Email"
            />
          </label>
        </div>
        <button className="mt-6 bg-red-600 text-yellow-400 px-4 py-2 rounded-lg">
          Get Started
        </button>
      </div>
